...
class SimpleController(Node):
    ...
    def __init__(self):
        ...
        self.vel_sub_ = self.create_subscription(TwistStamped, "robovacuum_controller/cmd_vel", self.velCallback, 10)
        self.joint_sub_ = self.create_subscription(JointState,"joint_states", self.jointCallback, 10)        
        self.odom_pub_ = self.create_publisher(Odometry, "robovacuum_controller/odom", 10)
